...
public class TestFlipkart extends BaseDriver {
	...
	// user Login
	@DataProvider(name = "UserAuthentication")
	public static Object[][] credentials() {
		return new Object[][] { { "shubham0011@gmail.com", "flipkart" } };

	}

	@Test(dataProvider = "UserAuthentication", priority = 0, alwaysRun = true, enabled = true)
	public void flipkartlogin(String sUsername, String sPassword) {
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("(//form[@autocomplete='on']/div/input)[1]")).sendKeys(sUsername);
		driver.findElement(By.xpath("(//form[@autocomplete='on']/div/input)[2]")).sendKeys(sPassword);
		driver.findElement(By.xpath("//button[@type='submit']/div")).submit();
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);

		// Assertion
		Assert.assertTrue("Online Shopping Site for Mobiles, Fashion, Books, Electronics, Home Appliances and More"
